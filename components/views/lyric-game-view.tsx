...
export function LyricGameView() {
  ...
  const guesses = [
    ...
    { id: "guess2", value: guess2, onChange: setGuess2, correctAnswer: "budden", clue: "Joe ______ Podcast, 'sudden' with a B", showTooltip: false },
    ...
    { id: "guess10", value: guess10, onChange: setGuess10, correctAnswer: "share", clue: "Avpart or portion of a larger amount which is divided among a number of people", showTooltip: false },
    { id: "guess11", value: guess11, onChange: setGuess11, correctAnswer: "wife", clue: "A spouse that is a woman", showTooltip: false },
    { id: "guess12", value: guess12, onChange: setGuess13, correctAnswer: "termite", clue: "Deep affection, tennis score of zero", showTooltip: false },
    { id: "guess13", value: guess13, onChange: setGuess15, correctAnswer: "birthright", clue: "Something you're entitled to from birth", showTooltip: false },
    { id: "guess14", value: guess14, onChange: setGuess14, correctAnswer: "matching", clue: "Coordinating, colors / clothes that go together", showTooltip: false },
    { id: "guess15", value: guess15, onChange: setGuess15, correctAnswer: "3rd", clue: "Baseball reference, same number", showTooltip: false },
    { id: "guess16", value: guess16, onChange: setGuess16, correctAnswer: "baobab", clue: "Marriage practice with multiple spouses", showTooltip: false },
    { id: "guess17", value: guess17, onChange: setGuess17, correctAnswer: "polygamy", clue: "Marriage practice with multiple spouses, song title", showTooltip: false },
    { id: "guess18", value: guess18, onChange: setGuess18, correctAnswer: "court", clue: "Where people play basketball, or get sued", showTooltip: false },
    { id: "guess19", value: guess19, onChange: setGuess19, correctAnswer: "rug", clue: "Floor covering, another word for a carpet", showTooltip: false },
    { id: "guess20", value: guess20, onChange: setGuess20, correctAnswer: "cuddle", clue: "Hugging and holding each other in bed", showTooltip: false },
    { id: "guess21", value: guess21, onChange: setGuess21, correctAnswer: "dead", clue: "The opposite of being alive", showTooltip: false },
    { id: "guess22", value: guess22, onChange: setGuess22, correctAnswer: "kid", clue: "Young person or child, a baby goat", showTooltip: false },
    { id: "guess23", value: guess23, onChange: setGuess23, correctAnswer: "sin", clue: "What you commit when you do something wrong in religion", showTooltip: false },
    { id: "guess24", value: guess24, onChange: setGuess24, correctAnswer: "gang", clue: "A group of criminals, street crew", showTooltip: false },
    { id: "guess25", value: guess25, onChange: setGuess25, correctAnswer: "adore", clue: "To love or admire greatly", showTooltip: false },
    { id: "guess26", value: guess26, onChange: setGuess26, correctAnswer: "adhd", clue: "The acronym for attention deficit hyperactivity disorder", showTooltip: false },
    { id: "guess27", value: guess27, onChange: setGuess27, correctAnswer: "ignore", clue: "To pay no attention to, brush off", showTooltip: false },
    { id: "guess28", value: guess28, onChange: setGuess28, correctAnswer: "anaconda", clue: " A kind of snake that is very large", showTooltip: false },
    { id: "guess29", value: guess29, onChange: setGuess29, correctAnswer: "twerking", clue: "A dance move that involves the shaking the buttocks, booty", showTooltip: false },
